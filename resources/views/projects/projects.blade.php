<x-layout>
    <div class="w-full md:w-3/4 px-4 py-2 md:py-10 md:px-8">
        <div class="flex flex-wrap mb-4">
            <div class="mx-4 cursor-pointer"><span class="text-gray-700 font-bold text-2xl">Projects</span></div>
        ...
        <div class="ml-4 grid grid-cols-4 md:grid-cols-5">   
            <div class="font-bold text-gray-600 border-y-2 border-l-2 border-slate-400 py-2 px-4">Project</div>
            <div class="md:col-span-2 font-bold text-gray-600 border-y-2 border-l-2 border-slate-400 py-2 px-4">Members</div>
            ...
            @foreach($projects as $project)
                ...
                <div class="py-2 px-4 text-gray-700 md:col-span-2 border-y-2 border-l-2 border-slate-400">{{ $project['members'] }}</div>
