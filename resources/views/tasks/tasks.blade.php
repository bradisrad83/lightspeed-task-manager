    ...
    <div class="w-full md:w-3/4 px-4 py-2 md:py-10 md:px-8">
        ...
        <div class="ml-4 grid grid-cols-5">   
            ...
            @foreach($tasks as $task)
                ...
                <div class="py-2 px-4 text-gray-700 border-y-2 border-l-2 border-slate-400"><a href="{{ route('users.show', ['user' => $task->user] )}}" class="cursor-pointer hover:underline hover:text-blue-800">{{ $task->user->name }}</a></div>
